...
from repr_control.agent.density.density import DensityEvaluationAgent
# from define_problem import *
from repr_control.envs.models.linear import *
...
if __name__ == "__main__":
    ...
    ### parameter that
    parser.add_argument("--alg", default="density",
    ...
    parser.add_argument("--max_timesteps", default=5e3, type=float,
    ...
    # Initialize policy
    if args.alg == "density":
        agent = DensityEvaluationAgent(dynamics_fn=dynamics,
                                       rewards_fn=rewards,
    ...
    torch.save(agent.density.state_dict(), log_path + "/critic_last.pth")
