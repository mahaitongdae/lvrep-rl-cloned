...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_timesteps", default=25e4, type=float)  # Max time steps to run environment
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if done:
            ...
            print(
                f"Total T: {t + 1} Episode Num: {episode_num + 1} Episode T: {episode_timesteps} Reward: {episode_reward:.3f} Terminal cost: {reward:.3f} Info: {rollout_info}")
            # Reset environment
