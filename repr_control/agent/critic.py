...
class DoubleDerivativeVCritic(nn.Module):
  """Critic network for continous time, learning partial V / partial x.
  ...
  def __init__(self, obs_dim, action_dim, hidden_dim, hidden_depth):
    ...
    self.Q1 = util.mlp(obs_dim, obs_dim, 1, hidden_depth)
    self.Q2 = util.mlp(obs_dim, obs_dim, 1, hidden_depth)
