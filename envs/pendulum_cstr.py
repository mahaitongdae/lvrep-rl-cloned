...
class PendulumCstrEnv(gym.Env):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, render_mode: Optional[str] = None, g=10.0, m=1.0):
        self.max_speed = 8
        self.max_torque = 2.0
        self.dt = 0.05
        self.g = g
    ...
    def step(self, u):
        ...
        costs = u**2 # angle_normalize(th) ** 2 + 0.1 * thdot**2 +
