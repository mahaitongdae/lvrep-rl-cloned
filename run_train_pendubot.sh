    ...
    for MAX_TIMESTEPS in 150000; do
      for RF_NUM in 4096; do
        for SEED in 1 2 3; do
          ...
          for R in 5.0 10.0 1.0; do
            python main.py --use_random_feature --no_reward_exponential --robust_feature --robust_radius $R --critic_lr 3e-4 --alg $ALG --env Pendubot-v0 --sigma $SIGMA --max_timesteps $MAX_TIMESTEPS --rf_num $RF_NUM --seed $SEED
          done
        done
      done
    done
